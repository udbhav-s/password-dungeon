...
var _get_ball_size = Module['_get_ball_size'] = makeInvalidEarlyAccess('_get_ball_size');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['get_ball_size'] != 'undefined', 'missing Wasm export: get_ball_size');
  ...
  _get_ball_size = Module['_get_ball_size'] = createExportWrapper('get_ball_size', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createRoom3Module;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createRoom3Module;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createRoom3Module);
