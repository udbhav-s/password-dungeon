...
function notify_memory() { Module.onProgramMemoryChanged?.(); }
function notify_success() { Module.onProgramSuccess?.(); }

// Imports from the Wasm binary.
var _get_crate_size = Module['_get_crate_size'] = makeInvalidEarlyAccess('_get_crate_size');
var _get_buffer_address = Module['_get_buffer_address'] = makeInvalidEarlyAccess('_get_buffer_address');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['get_crate_size'] != 'undefined', 'missing Wasm export: get_crate_size');
  assert(typeof wasmExports['get_buffer_address'] != 'undefined', 'missing Wasm export: get_buffer_address');
  ...
  _get_crate_size = Module['_get_crate_size'] = createExportWrapper('get_crate_size', 0);
  _get_buffer_address = Module['_get_buffer_address'] = createExportWrapper('get_buffer_address', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createRoom5AModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createRoom5AModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createRoom5AModule);
